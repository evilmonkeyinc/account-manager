...
func request_Openapi_FetchPlugin_0(ctx context.Context, marshaler runtime.Marshaler, client OpenapiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FetchPluginParameters
	var metadata runtime.ServerMetadata
	...
	msg, err := client.FetchPlugin(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Openapi_FetchPlugin_0(ctx context.Context, marshaler runtime.Marshaler, server OpenapiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FetchPluginParameters
	var metadata runtime.ServerMetadata
	...
	msg, err := server.FetchPlugin(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterOpenapiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OpenapiServer) error {
	...
	mux.Handle("GET", pattern_Openapi_FetchPlugin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_Openapi_FetchPlugin_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_Openapi_FetchPlugin_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOpenapiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OpenapiClient) error {
	...
	mux.Handle("GET", pattern_Openapi_FetchPlugin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Openapi_FetchPlugin_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Openapi_FetchPlugin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"plugins", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Openapi_ListPlugins_0 = runtime.ForwardResponseMessage

	forward_Openapi_FetchPlugin_0 = runtime.ForwardResponseMessage
)
